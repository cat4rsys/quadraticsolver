...
///
/// @note If user entered something, that starts with q, but it is not 'q\n', function returns \n
/// UNKNOWN_SYMBOL
///-----------------------------------------------------------------------------------------------
...
///
/// @note If user did not entered the number, num will equal 1.0 after entering 'x' or 'X' symbol \n
/// (for example x = 1*x) \n
